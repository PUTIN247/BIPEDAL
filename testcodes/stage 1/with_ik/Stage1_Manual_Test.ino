...
// Define Channels (Match your previous setup)
...
void setup() {
    ...
    Serial.println("=== STAGE 1: MANUAL VIRTUAL JOYSTICK ===");
...
void loop() {
    if (Serial.available() > 0) {
        ...
        switch (cmd) {
            ...
            // RESET
            case 'x': 
                currentHip = 0; currentKnee = 0; currentAnkle = 0; 
                Serial.println("Resetting to Home.");
                break;
        }

        // --- CRITICAL SAFETY LIMITS [cite: 69, 141] ---
        // Hip: -45 to 45
...
void updateServos() {
    ...
    // Using setServoRaw which we just made public
